#!/bin/bash
# Script para remoção de snapshots no projeto operations-dashboards
# Data: 14/05/2025
...
SNAPSHOTS=(
    "dashboards-vm-test-backup1"
    "dashboards-vm-test-backup2"
)

# Iniciar processo de remoção
log "Iniciando remoção de snapshots no projeto $PROJETO"
